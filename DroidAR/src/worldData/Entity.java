...
public interface Entity extends Updateable, Visitable {
	 ...
	 * soon as {@link Updateable#update(float, Updateable)}
	 * is called. <br>
	 * <br>
	 ...
	 * {@link Updateable#update(float, Updateable)} if the
	 * component ha s children because these children might call
	 * {@link Entity#getMyParent()} to navigate through the Scene Graph
	 * 
